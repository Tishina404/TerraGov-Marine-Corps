...
GLOBAL_LIST_INIT(engineer_gear_listed_products, list(
		...
		/obj/item/clothing/head/superior_welding = list(CAT_ENGSUP, "Superior welding helmet", 4, "engi-tool"),
...
GLOBAL_LIST_INIT(smartgunner_gear_listed_products, list(
	...
	/obj/item/ammo_magazine/minigun_powerpack/smartgun = list(CAT_SGSUP, "SG-85 Powerpack", 10, "sg-minigun"),
	/obj/item/ammo_magazine/packet/smart_minigun = list(CAT_SGSUP, "SG-85 Ammo Bin", 4, "sg-minigun"),
	...
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/flak = list(CAT_SGSUP, "SG-153 Spotting Rifle Flak Magazine", 2, "sg-targetrifle"),
	/obj/item/ammo_magazine/rifle/standard_spottingrifle/plasmaloss = list(CAT_SGSUP, "SG-153 Spotting Rifle Tanglefoot Magazine", 3, "sg-targetrifle"),
